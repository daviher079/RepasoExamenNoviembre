...
<body>
    ...
    <main>
        ...
        <form action="RepasoFicherosCSVEscritura.php" method="post">
        ...
        ?>
            ...
            <section id="botones" style="margin-top:35px;">
                ...
                <a href="./RepasoFicherosCSVLectura.php">Volver</a>
            </section>
        </form>    
        ...
        <?php
            if(sizeof($_REQUEST)>0 && isset($_REQUEST['boton']))
            {
                if($_REQUEST['boton']=='Guardar')
                {
                    if(file_exists($rutaFichero)==true)
                    {
                        $rutaFicheroTemp="./Ficheros/temp.csv";

                        if(!$fNotas=fopen($rutaFichero, 'r'))
                        {
                            echo"Error no se ha podido abrir el ficheroj";
                            exit;
                        }
                        ...
                        {
                            echo"Error no se ha podido abrir el ficherol";
                            exit;
                        }
                        ...
                        header('Location: ./RepasoFicherosCSVLectura.php');
